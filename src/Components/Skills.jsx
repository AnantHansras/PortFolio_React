  ...
  return (
    <div ref={ref} className="pt-[129px] mb-12">
      <div
        className={`${
          darkMode
            ? "bg-[rgba(50,50,50,0.3)] text-white"
            : "bg-[#f6656e30] text-black"
      ...
      >
        ...
        <div
          className={`${
            darkMode ? "text-white" : "text-black"
          } font-bold text-xl md:text-2xl mx-auto text-center mb-6`}
        >
          SKILLS
        </div>
        ...
        {/* Tabs */}
        <div
          className={`flex flex-wrap md:flex-nowrap justify-center items-center border-b border-b-[#424854] text-sm md:text-base lg:text-lg mb-10 gap-2`}
        >
          <p
